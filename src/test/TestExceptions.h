...
class ex_GIVE_SIGNERS_ACCESS_LOW_RESERVE
{
};
class ex_GIVE_SIGNERS_ACCESS_FRIEND_IS_SOURCE
{
};
class ex_GIVE_SIGNERS_ACCESS_FRIEND_DOESNT_EXIST
{
};
class ex_GIVE_SIGNERS_ACCESS_ACCESS_SRC_NOT_AUTHORISED
{
};

class ex_SET_SIGNERS_LOW_RESERVE
{
};
class ex_SET_SIGNERS_INVALID_ACCESS
{
};
class ex_SET_SIGNERS_FRIEND_IS_SOURCE
{
};
class ex_SET_SIGNERS_ACCESS_GIVER_DOESNT_EXIST
{
};
class ex_SET_SIGNERS_ACCESS_ENTRY_DOESNT_EXIST
{
};
class ex_SET_SIGNERS_BAD_SIGNER
{
};
