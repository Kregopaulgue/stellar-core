...
class ex_GIVE_SIGNERS_ACCESS_SIGNERS_ACCESS_ALREADY_EXISTS
{
};
class ex_GIVE_SIGNERS_ACCESS_TIME_FRAMES_EQUAL_OR_LESS_THEN_CURRENT_TIME
{
};
...
class ex_SET_SIGNERS_CURRENT_TIME_NOT_WITHIN_ACCESS_TIME_FRAMES
{
};
